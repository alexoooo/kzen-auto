...
//-----------------------------------------------------------------------------------------------------------------
external interface SelectScriptEditorState: State {
...
class SelectScriptEditor(
    ...
    RPureComponent<AttributeEditorProps, SelectScriptEditorState>(props),
    LocalGraphStore.Observer
{
        ...
        AttributeEditorWrapper(objectLocation)
    {
        override fun ChildrenBuilder.child(block: AttributeEditorProps.() -> Unit) {
            SelectScriptEditor::class.react {
                block()
            }
        }
    }
    ...
    //-----------------------------------------------------------------------------------------------------------------
    override fun SelectScriptEditorState.init(props: AttributeEditorProps) {
//        console.log("ParameterEditor | State.init - ${props.name}")
    ...
    override fun componentDidUpdate(
        ...
        prevState: SelectScriptEditorState,
        snapshot: Any
    ) {
