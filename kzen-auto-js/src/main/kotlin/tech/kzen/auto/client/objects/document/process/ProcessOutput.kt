...
import tech.kzen.auto.client.objects.document.process.state.ProcessSaveAction
...
//        console.log("^^^^ abbreviating: $value")
    ...
    private fun RBuilder.renderHeaderControls() {
        val showRefresh = props.processState.isTaskRunning()
        val showSave = props.processState.outputInfo?.modifiedTime != null
            ...
            styledDiv {
                ...
                child(AttributePathValueEditor::class) {
                    attrs {
                        ...
                        attributePath = ProcessConventions.saveFilePath
