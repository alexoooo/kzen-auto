...
> until synthesis runs). Two things about Job are worth knowing generally, because they are where
...
> **Report → Logic (2026-06-30).** Reports were the last holdout of the Task paradigm; they now run as
