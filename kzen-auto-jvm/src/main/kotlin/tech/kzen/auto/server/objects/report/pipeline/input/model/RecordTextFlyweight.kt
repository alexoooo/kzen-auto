...
class RecordTextFlyweight(
    val recordLineBuffer: RecordItemBuffer,
):
    CharSequence
{
    //-----------------------------------------------------------------------------------------------------------------
    companion object {
        ...
        fun standalone(value: String): RecordTextFlyweight {
            ...
            val buffer = RecordItemBuffer.of(chars, 0, chars.size)
...
//        }
    ...
    fun detach(): RecordTextFlyweight {
        val buffer = RecordItemBuffer.of(recordLineBuffer.fieldContents, valueOffset, valueLength)
...
//    @Suppress("ConvertTwoComparisonsToRangeCheck")
    ...
    fun toLong(
        ...
        if (length <= 0) {
            throw NumberFormatException("offset = $offset, length = $length: " + toString())
        }
