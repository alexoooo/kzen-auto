 ...
 * action steps, disposed per its `closePolicy` when the OWNING document settles (the furthest one along the
 * providing document's chain of `context.exports` declarations, else the providing one), or by an explicit
 * Close step.
 *
