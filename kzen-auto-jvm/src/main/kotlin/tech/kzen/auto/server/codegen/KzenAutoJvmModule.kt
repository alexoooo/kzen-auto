// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2021-04-05T23:29:52.833939600
...
reflectionRegistry.put(
    ...
    PluginDocument(args[0] as String)
}

reflectionRegistry.put(
    "tech.kzen.auto.server.objects.report.ReportDocument",
    listOf("input", "formula", "filter", "pivot", "output", "selfLocation")
) { args ->
    ReportDocument(args[0] as InputSpec, args[1] as FormulaSpec, args[2] as FilterSpec, args[3] as PivotSpec, args[4] as OutputSpec, args[5] as ObjectLocation)
}
