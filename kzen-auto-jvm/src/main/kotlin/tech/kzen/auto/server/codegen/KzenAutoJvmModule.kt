// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2026-05-18T12:23:40.763757700
...
import tech.kzen.auto.server.objects.custom.CustomDocument
import tech.kzen.auto.server.objects.custom.test.AdhocLogic
import tech.kzen.auto.server.objects.custom.test.AdhocNamed
import tech.kzen.auto.server.objects.custom.test.AdhocNamedImpl
...
import tech.kzen.auto.server.objects.sequence.step.value.ArgumentStep
...
reflectionRegistry.put(
    "tech.kzen.auto.server.objects.custom.CustomDocument",
    listOf()
) {
    CustomDocument()
}
...
reflectionRegistry.put(
    "tech.kzen.auto.server.objects.custom.test.AdhocLogic",
    listOf("named")
) { args ->
    AdhocLogic(args[0] as AdhocNamed)
}

reflectionRegistry.put(
    "tech.kzen.auto.server.objects.custom.test.AdhocNamedImpl",
    listOf("name")
) { args ->
    AdhocNamedImpl(args[0] as String)
}
