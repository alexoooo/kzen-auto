// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2021-08-25T21:21:27.551511500
...
import tech.kzen.auto.server.objects.pipeline.PipelineDocument
...
reflectionRegistry.put(
    "tech.kzen.auto.server.objects.pipeline.PipelineDocument",
    listOf("input", "formula", "previewAll", "filter", "previewFiltered", "analysis", "output", "selfLocation")
) { args ->
    PipelineDocument(args[0] as InputSpec, args[1] as FormulaSpec, args[2] as PreviewSpec, args[3] as FilterSpec, args[4] as PreviewSpec, args[5] as AnalysisSpec, args[6] as OutputSpec, args[7] as ObjectLocation)
}
