// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2023-07-20T09:49:39.739841800
...
import tech.kzen.auto.server.objects.sequence.step.RunStep
import tech.kzen.auto.server.objects.sequence.step.WaitStep
...
reflectionRegistry.put(
    ...
    IfStep(args[0] as ObjectLocation, args[1] as ObjectLocation, args[2] as ObjectLocation)
}
...
reflectionRegistry.put(
    "tech.kzen.auto.server.objects.sequence.step.RunStep",
    listOf("instructions")
) { args ->
...
reflectionRegistry.put(
    "tech.kzen.auto.server.objects.sequence.step.WaitStep",
