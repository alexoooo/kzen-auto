// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2020-11-10T12:12:27.800564100
...
reflectionRegistry.put(
    ...
    listOf("input", "filter", "pivot", "output", "selfLocation")
) { args ->
    ProcessDocument(args[0] as String, args[1] as FilterSpec, args[2] as PivotSpec, args[3] as OutputSpec, args[4] as ObjectLocation)
}
