    ...
    companion object {
        ...
        fun fromCollection(
            ...
            return VisualVertexModel(
                    ...
                    // Tolerate Number: when this model is carried through an ExecutionValue (the Flow
                    // logic-trace channel) the epoch round-trips as a Double, not an Int.
                    (collection[epochKey] as Number).toInt(),
