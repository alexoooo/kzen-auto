...
data class DataSchemaFieldSpec(
    val typeMetadata: TypeMetadata
) {
    //-----------------------------------------------------------------------------------------------------------------
    companion object {
        val any = DataSchemaFieldSpec(TypeMetadata.any)

        fun ofNotation(attributeNotation: MapAttributeNotation): DataSchemaFieldSpec {
            val typeMetadata = readTypeMetadata(attributeNotation)
            return DataSchemaFieldSpec(typeMetadata)
        }
