 ...
 * captures its single upstream message as the vertex's own message and harvests that into the result tuple
 * under [tupleComponentName], so [FlowVertex.process] is never called.
 *
