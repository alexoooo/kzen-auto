// **DO NOT EDIT, CHANGES WILL BE LOST** - automatically generated by ModuleReflectionGenerator at 2020-11-24T21:06:30.226897300
...
reflectionRegistry.put(
    "tech.kzen.auto.common.objects.document.report.spec.FilterSpec\$Definer",
    listOf()
) {
    FilterSpec.Definer
}
...
reflectionRegistry.put(
    "tech.kzen.auto.common.objects.document.report.spec.OutputSpec\$Definer",
    listOf()
) {
    OutputSpec.Definer
}
...
reflectionRegistry.put(
    "tech.kzen.auto.common.objects.document.report.spec.PivotSpec\$Definer",
    listOf()
) {
    PivotSpec.Definer
}
